...
1. **Lógica Visual de Lista:** Estude o arquivo `components/RideOptionsCard.tsx` apenas para copiar a lógica de como ele seleciona o item na lista (o efeito de borda colorida ao clicar).
...
_O arquivo JSON_ "Midnight Commander".
