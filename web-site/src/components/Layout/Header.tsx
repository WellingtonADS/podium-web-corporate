import { Box, Button, Flex, HStack, Icon, useBreakpointValue } from "@chakra-ui/react";
    ...
    >
      ...
      >
        ...
        <HStack spacing={2} cursor="pointer" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
          ...
          <Box>
            <Box fontFamily="heading" fontWeight="bold" fontSize="lg" color="gold.600" letterSpacing="0.1em">
              PODIUM
            </Box>
            <Box fontSize="2xs" color="whiteAlpha.600" letterSpacing="0.15em" fontWeight="500">
              Rent A Car
            </Box>
          </Box>
        </HStack>
